...
const Home = (props) => {
    ...
    function InitScripts() {
        ...
        if (navbar && navTogglers && navLinks && overlay) {
                    ...
                    <section className="section about" id="about" aria-label="about">
                        <div className="container">
                            ...
                            <div className="about-content">
                                ...
                                <h2 className="h2 section-title">
                                    Over 10 Years in
                                    <span className="span">Distant learning</span>
                    ...
                    <section className="section stats" aria-label="stats">
                        <div className="container">
                            ...
                            <ul className="grid-list">
                                ...
                                <li>
                                    <div className="stats-card stats-card1">
                                ...
                                <li>
                                    <div className="stats-card stats-card2">
                                ...
                                <li>
                                    <div className="stats-card stats-card3">
                                ...
                                <li>
                                    <div className="stats-card stats-card4">
